...
var Incoming = React.createClass({
  ...
  render:function(){
    ...
    return(<div>
      ...
      <p>Use the arrow keys to shift all the tiles left, right, top, or down. The tiles will contain some form or currency, and if two identical tiles run into one another, they will combine to for a higher currency. Can you reach the 100 dollar bills?</p>
